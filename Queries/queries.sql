...
-- Remove the retirement_info table to create a new table with different fields
...
-- Joining departments and dept_manager tables - refactored code
SELECT d.dept_name,
     dm.emp_no,
     dm.from_date,
     dm.to_date
...
-- Joining retirement_info and dept_emp tables - refactored code
SELECT ri.emp_no,
    ri.first_name,
	ri.last_name,
    de.to_date
...
-- Retrieve data from Emp & Titles tables into a new table
